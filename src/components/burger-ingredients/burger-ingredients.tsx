...
export const BurgerIngredients: FC = () => {
  ...
  const buns: TIngredient[] = items.filter((i) => i.type === 'bun');
  const mains: TIngredient[] = items.filter((i) => i.type === 'main');
  const sauces: TIngredient[] = items.filter((i) => i.type === 'sauce');
